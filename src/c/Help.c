...
void helpPasien(){
    ...
    printf(
        ...
        "9) LUPA_PASSWORD : Mengganti atau memperbarui password akun\n"
        "10) LOGOUT : Keluar dari akun yang sedang digunakan\n"
        "11) EXIT : Keluar dari program\n\n"
        "Footnote:\n"
...
void helpDokter(){
    ...
    printf(
        ...
        "6) LUPA_PASSWORD : Mengganti atau memperbarui password akun\n"
        "7) LOGOUT : Keluar dari akun yang sedang digunakan\n"
...
void helpManager(){
    ...
    printf(
        ...
        "15) LUPA_PASSWORD : Mengganti atau memperbarui password akun\n"
        "16) LOGOUT : Keluar dari akun yang sedang digunakan\n"
